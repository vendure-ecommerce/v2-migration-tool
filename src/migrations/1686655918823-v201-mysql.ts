...
export class v201Mysql1686655918823 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `channel` ADD `availableCurrencyCodes` text NULL", undefined);
        await queryRunner.query("ALTER TABLE `channel` ADD `trackInventory` tinyint NOT NULL DEFAULT 1", undefined);
        await queryRunner.query("ALTER TABLE `channel` ADD `outOfStockThreshold` int NOT NULL DEFAULT '0'", undefined);
        await queryRunner.query("ALTER TABLE `channel` ADD `sellerId` int NULL", undefined);
        await queryRunner.query("ALTER TABLE `collection` ADD `inheritFilters` tinyint NOT NULL DEFAULT 1", undefined);
        await queryRunner.query("ALTER TABLE `product_variant_price` ADD `currencyCode` varchar(255) NULL", undefined);
        await queryRunner.query("ALTER TABLE `order_line` ADD `quantity` int NULL", undefined);
        await queryRunner.query("ALTER TABLE `order_line` ADD `orderPlacedQuantity` int NOT NULL DEFAULT '0'", undefined);
        await queryRunner.query("ALTER TABLE `order_line` ADD `listPriceIncludesTax` tinyint NULL", undefined);
        await queryRunner.query("ALTER TABLE `order_line` ADD `adjustments` text NULL", undefined);
        await queryRunner.query("ALTER TABLE `order_line` ADD `taxLines` text NULL", undefined);
        await queryRunner.query("ALTER TABLE `order_line` ADD `sellerChannelId` int NULL", undefined);
        await queryRunner.query("ALTER TABLE `order_line` ADD `shippingLineId` int NULL", undefined);
        await queryRunner.query("ALTER TABLE `order_line` ADD `initialListPrice` int NULL", undefined);
        await queryRunner.query("ALTER TABLE `order_line` ADD `listPrice` int NULL", undefined);
        await queryRunner.query("ALTER TABLE `order` ADD `type` varchar(255) NOT NULL DEFAULT 'Regular'", undefined);
        await queryRunner.query("ALTER TABLE `order` ADD `aggregateOrderId` int NULL", undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `order_line` ADD CONSTRAINT `FK_cbcd22193eda94668e84d33f185` FOREIGN KEY (`productVariantId`) REFERENCES `product_variant`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION", undefined);
        await queryRunner.query("ALTER TABLE `product_variant_price` CHANGE `channelId` `channelId` int NOT NULL", undefined);
        ...
        await queryRunner.query("ALTER TABLE `promotion` ADD `name` varchar(255) NOT NULL", undefined);
        await queryRunner.query("ALTER TABLE `product_variant` ADD `stockAllocated` int NOT NULL DEFAULT '0'", undefined);
        await queryRunner.query("ALTER TABLE `product_variant` ADD `stockOnHand` int NOT NULL DEFAULT '0'", undefined);
        await queryRunner.query("ALTER TABLE `channel` ADD `currencyCode` varchar(255) NOT NULL", undefined);
